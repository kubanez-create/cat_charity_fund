...
from app.api.validators import (
    check_project_exists, check_invested_amount_not_zero,
    check_project_not_closed, check_name_duplicate,
...
async def partially_update_project(
    ...
    """Только для суперюзеров."""
    project = await check_project_not_closed(
        project_id, session
    )
    ...
    meeting_room = await project_crud.update(
